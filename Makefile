...
CCOPTS = $(MACOS_CCOPTS) -I/usr/X11R6/include -I/usr/X11R6/include/X11 -I. -Wall $(OPTIMIZE) $(DEBUG) $(PROFILE) \
	 -DMETAPIXEL_VERSION=\"$(VERSION)\" -DRWIMG_JPEG -DRWIMG_PNG
CC = gcc
#LIBFFM = -lffm

LISPREADER_OBJS = lispreader.o pools.o allocator.o
OBJS = main.o bitmap.o metric.o matcher.o tiling.o metapixel.o library.o classic.o collage.o search.o utils.o \
